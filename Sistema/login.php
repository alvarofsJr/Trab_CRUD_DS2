...
if (isset($_POST['entrar'])) {
    if (isset($_POST['credencial']) && isset($_POST['senha']) && !empty($_POST['credencial']) && !empty($_POST['senha'])) {
        session_start();
        require '../Database/conexao.php';
        $credencial = $_POST['credencial'];
        $senha = $_POST['senha'];

        $sql = "SELECT * FROM funcionarios WHERE credencial = :credencial AND senha = :senha";
        ...
        if ($resultado->rowCount() > 0) {
            ...
            $_SESSION['id'] = $dado['id'];
            $_SESSION['credencial'] = $dado['nome'];

            header('Location: ../index.php');
        } else {
            $error = "Credencial ou senha inválidos ";
        }
    }
}
?>
        ...
        <div class="card shadow" style="width: 100%; max-width: 400px;">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <img src="../Form/login/imagens/LogoNxpLT.jpeg" alt="Imagem" style="height: 60px;">
                ...
                <form method="POST" action="" data-parsley-validate>
                    ...
                    <div class="input-container pb-2">
                        ...
                        <input 
                            ...
                            pattern="^\S(.*\S)?$"
                            data-parsley-required-message="A senha não pode contér espaços"
